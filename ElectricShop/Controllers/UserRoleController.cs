	...
	public class UserRoleController: ApiController
	{
		public async Task<IHttpActionResult> Get()
		{
			try
			{
				...
				#endregion
				var lstData = MemoryInfo.GetAllUserRole();
		...
		public async Task<IHttpActionResult> Post([FromBody]UserRole req)
		{
			try
			{
		...
		public async Task<IHttpActionResult> Put(int id,[FromBody]UserRole req)
		{
			try
			{
				string errorMessage = "UnknowError";
				...
				#region Check exist
				var obj = MemoryInfo.GetUserRole(id);
				if (obj == null)
				{
